module.exports = {
    ...
    run: async (client, message, args) => {
        switch (args[0]) {
            default: message.edit(client.language(`***__Stealy - Hypesquad__*** <a:star:1345073135095123978>
...
\`${client.db.prefix}hype brillance\` › *Avoir le badge brillance de la hypesquad.*`,

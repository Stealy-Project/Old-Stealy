...
> ***${user.banner ? `[\`Lien de la Bannière\` ](https://cdn.discordapp.com/banners/${user.id}/${user.banner}.gif?size=4096)` : "\`Pas de bannière\`"} ***`,
`***__› Stealy - User Info__*** <a:star:1345073135095123978>
...
> ***${user.banner ? `[ \`Link of the Banner\` ](https://cdn.discordapp.com/banners/${user.id}/${user.banner}.gif?size=4096)` : "\`No banner\`"} ***`
        ))
    }
}
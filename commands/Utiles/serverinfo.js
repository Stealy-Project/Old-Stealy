module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const createdAt = guild.createdAt.getTime();
        const now = Date.now();
        const diff = now - createdAt;
        const crea = Math.floor(diff / 1000 / 60 / 60 / 24);

      message.edit(client.language(`***__› Stealy - Server Info__*** <a:star:1345073135095123978>
...
> ***Jours depuis la création :*** [\`${crea}\`](<https://discord.gg/stealy>)
...
> ***Bannière d'invitation :*** ${guild.splash ? `[\`Lien de la banniere d'invitation\`](https://cdn.discordapp.com/splashes/${guild.id}/${guild.splash}.png?size=4096)` : "[`Pas de bannière`](<https://discord.gg/stealy>)"}`,
...
> ***Days since the creation :*** [\`${crea}\`](<https://discord.gg/stealy>)
...
> ***Server Splash :*** ${guild.splash ? `[\`Lien de la banniere d'invitation\`](https://cdn.discordapp.com/splashes/${guild.id}/${guild.splash}.png?size=4096)` : "[`Pas de bannière`](<https://discord.gg/stealy>)"}`))
    }
}
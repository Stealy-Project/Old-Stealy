...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!profile.banner) return message.edit(client.language(`***[ \`@${user.username}\` ](<https://discord.gg/stealy>)ne possède pas de bannière.***`, `<a:star:1345073135095123978> **__Stealy__** <a:star:1345073135095123978>\n***[ \`@${user.username}\` ](<https://discord.gg/stealy>)has no banner.***`));

module.exports = {
  ...
  run: async (client, message) => {
    ...
    message.edit(client.language(`***___› Stealy - Fun___*** <a:star:1345073135095123978>
...
\`${client.db.prefix}nitro\` › *Drop un faux nitro.*`,
...
\`${client.db.prefix}nitro\` › *Drop a fake nitro.*`));
    }
}
module.exports = {
    ...
    run: async (client, message) => {
        ...
        message.edit(client.language(`***___› Stealy ___*** <a:star:1345073135095123978>

${client.replace(client.db.desc) || "-# *La guerre ne détermine pas ce qui est bon ou ce qui est mauvais.*"}
...
\`${client.db.prefix}group\` › *Commandes groupes.*`
,
`***___› Stealy ___*** <a:star:1345073135095123978>
${client.replace(client.db.desc) || "-# *War does not determine who is good or what is bad*"}
...
\`${client.db.prefix}group\` › *Group commands.*`))
    }
}
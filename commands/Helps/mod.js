module.exports = {
    ...
    run: async (client, message) => {
        message.edit(client.language(`***___› Stealy - Moderation___*** <a:star:1345073135095123978>
...
\`${client.db.prefix}kick <id/mention> <raison>\` › *Expulser un membre.*`,
...
\`${client.db.prefix}kick <id/mention> <reason>\` › *Kick a member.*`));
  }
}
